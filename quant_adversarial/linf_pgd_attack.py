...
def pgd(inputs, net, epsilon=[1.], targets=None, pytorch_range=[], step_size=0.04, num_steps=20, epsil=5./255.*8):
    """
...
def modified_pgd(inputs, net, args, sp_scalar, epsilon=[1.], targets=None, pytorch_range=[], step_size=0.04, num_steps=20, epsil=5./255.*8):
    use_cuda = torch.cuda.is_available()
    device = torch.device("cuda" if use_cuda else "cpu")
